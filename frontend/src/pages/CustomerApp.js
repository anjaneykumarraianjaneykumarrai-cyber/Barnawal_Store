...
export default function CustomerApp() {
  ...
  if (splash) return <section data-testid="splash-screen" className="splash-screen"><div data-testid="splash-logo" className="splash-logo">BGS</div><h1 data-testid="splash-store-name">BARNAWAL PROVISION STORE</h1><DeliveryBadge /></section>;
  return (
